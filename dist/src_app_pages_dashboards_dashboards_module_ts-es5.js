(function () {
  ...
  (self["webpackChunkngx_admin"] = self["webpackChunkngx_admin"] || []).push([["src_app_pages_dashboards_dashboards_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _DashboardService = /*#__PURE__*/function () {
        ...
        _createClass(_DashboardService, [{
          key: "getClientCompanyChart",
          value: function getClientCompanyChart() {
          ...
          key: "getClientByRegion",
          value: function getClientByRegion() {
            return apollo_angular__WEBPACK_IMPORTED_MODULE_0__.gql(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n      {\n        getClientByRegion {\n          name\n          value\n        }\n      }\n    "])));
          }
        }, {
          key: "getIssuesChart",
          value: function getIssuesChart() {
            return apollo_angular__WEBPACK_IMPORTED_MODULE_0__.gql(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n      {\n        getIssuesChart {\n          name\n          value\n        }\n      }\n    "])));
          }
        }, {
          key: "cardTech",
          value: function cardTech() {
            return apollo_angular__WEBPACK_IMPORTED_MODULE_0__.gql(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n      {\n        getTicketByProfile {\n          techName\n          totalDiag\n          totalRep\n          moyDiag\n          moyRep\n          techCostRep\n          techCostDiag\n        }\n      }\n    "])));
          }
        }, {
          key: "getTotality",
          value: function getTotality() {
            return apollo_angular__WEBPACK_IMPORTED_MODULE_0__.gql(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n      {\n        totality {\n          totality {\n            name\n            value\n          }\n          count\n        }\n      }\n    "])));
          }
          /**
           * finalPrice
           * status
          ...
          value: function prices() {
            ...
            return apollo_angular__WEBPACK_IMPORTED_MODULE_0__.gql(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n      {\n        getTicketForCoordinator {\n          finalPrice\n          status\n          composants {\n            quantity\n            sellPrice\n          }\n        }\n      }\n    "])));
          }
        }, {
          key: "calendarChart",
          value: function calendarChart() {
            return apollo_angular__WEBPACK_IMPORTED_MODULE_0__.gql(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n      {\n        getClientLastMonth {\n          date\n          value\n        }\n      }\n    "])));
          }
        }, {
          key: "filterGain",
          value: function filterGain(filter) {
            return apollo_angular__WEBPACK_IMPORTED_MODULE_0__.gql(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n      mutation {\n        filterGain(filter: { start: \"", "\", end: \"", "\" }) {\n          createdAt\n        }\n      }\n    "])), filter.start, filter.end ? filter.end : null);
          }
        }]);
      ...
      _DashboardService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ticket_ticket_ticket_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _DashboardComponent = /*#__PURE__*/function () {
        function _DashboardComponent(apollo, dashboardService, ticketService) {
          ...
          this.options = {
            ...
            color: ["#FF0000", "#0000FF", "#00FF00", "#FFFF00", "#FFA500", "#800080", "#FFC0CB"],
            tooltip: {
              trigger: "item",
        ...
        _createClass(_DashboardComponent, [{
          ...
          value: function getTotality() {
            ...
            this.apollo.query({
              ...
              _this.totalityCard = data.totality;

              var _data$totality$flatMa = data.totality.flatMap(function (el) {
                return el.count;
              });

              var _data$totality$flatMa2 = _slicedToArray(_data$totality$flatMa, 1);

              _this.totalTicket = _data$totality$flatMa2[0];

              _this.totalityCard.map(function (el) {
                console.log(el.totality, "el");
                el.totality.map(function (item) {
                  if (item.name === "FINISHED") {
                    _this.ticketFinie = item.value;
                    console.log(item.value, "test");
                  }

                  if (item.name === "PENDING") {
                    _this.enAttente = +item.value;
                  }

                  if (item.name === "IN_PROGRESS") {
                    _this.ticketEnCours = +item.value;
                  }

                  if (item.name === "RETURN") {
                    _this.ticketRetour = +item.value;
                  }

                  if (item.name === "IGNORED") {
                    _this.ticketAnnuler = +item.value;
                  }
                });
              });
            });
          ...
          value: function getChart() {
            ...
            this.apollo.query({
              ...
              _this2.options = {
                backgroundColor: echarts__WEBPACK_IMPORTED_MODULE_0__.bg,
                color: ["#00E699", "#FFB400", "#FF5D76", "#00D992", "#FFB600", "#FF6A7B", "#00E28D", "#FFAE00", "#FF777E"],
                tooltip: {
                  trigger: "item",
                  formatter: "{a} <br/>{b} : {c} ({d}%)"
                },
          ...
          key: "getAllTech",
          value: function getAllTech() {
            this.apollo.query({
              query: this.ticketService.getAllTech()
            }).subscribe(function (_ref3) {
              var data = _ref3.data;
              console.log(data); // this.techs = data.getAllTech;
            });
          }
        }, {
          key: "getClientByRegion",
          value: function getClientByRegion() {
            ...
            this.apollo.query({
              ...
              var names = _this3.option = {
                xAxis: {
                  type: "category",
                  data: data.getClientByRegion.map(function (el) {
                    return el.name;
                  })
                },
                yAxis: {
          ...
          value: function getIssuesChart() {
            ...
            this.apollo.query({
              ...
              _this4.issueChart = {
                backgroundColor: echarts__WEBPACK_IMPORTED_MODULE_0__.bg,
                color: ["#FF5D76", "#00D992", "#FFB600", "#FF6A7B", "#00E28D", "#FFAE00", "#FF777E"],
                tooltip: {
                  trigger: "item",
                  formatter: "{a} <br/>{b} : {c} ({d}%)"
                },
          ...
          value: function cardTech() {
            ...
            this.apollo.query({
              ...
              _this5.techs = data.getTicketByProfile;
            });
          }
        }, {
          key: "price",
          value: function price() {
            ...
            this.apollo.query({
              ...
              data.getTicketForCoordinator.filter(function (el) {
                if (el) {
                  if (el.status === "FINISHED") {
                    _this6.totalPrice += parseFloat(el.finalPrice);
                    console.log(_this6.totalPrice, "total in");
                  }

                  if (el.status === "RETURN") {
                    _this6.totalPriceReturn += parseFloat(el.finalPrice);
                    console.log(_this6.totalPrice, "total in");
                  }

                  el.composants.map(function (el) {
                    _this6.totalcomposants = el.sellPrice * el.quantity;
                    console.log("total composants === ", _this6.totalcomposants);
                  });
                }
              });
            });
          ...
          value: function calendarChart() {
            ...
            this.apollo.query({
              ...
              _this7.optClient = {
                xAxis: {
                  type: "category",
                  data: data.getClientLastMonth.map(function (el) {
                    return el.date;
                  })
                },
                yAxis: {
          ...
          key: "filterGainByDate",
          value: function filterGainByDate() {
            var _this8 = this;

            console.log("HELOOOOOOOOOOOOO WORLD");
            this.gainFrom.get("filterGain").valueChanges.subscribe(function (f) {
              var startDate = f.start ? new Date(f.start) : null;
              var endDate = f.end ? new Date(f.end) : null;
              ...
              _this8.apollo.mutate({
                mutation: _this8.dashboardService.filterGain(filter)
      ...
      _DashboardComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
        ...
        decls: 108,
        vars: 34,
        consts: [[1, "row"], [1, "col-lg-2", "card-size", "custom-border-total"], [1, "col-lg-2", "card-size", "custom-border-pending"], ["accent", "info", 1, "col-lg-2", "card-size"], ["accent", "success", 1, "col-lg-2", "card-size"], ["accent", "warning", 1, "col-lg-2", "card-size"], ["accent", "danger", 1, "col-lg-2", "card-size"], [1, "col-lg-12", "equal-width-table"], [1, "header-tech"], ["nbTooltip", "Temps total diagnostique"], ["nbTooltip", "Temps total R\xE9paration"], ["nbTooltip", "Temps moyen diagnostique"], ["nbTooltip", "Temps moyen R\xE9paration"], ["nbTooltip", "Prix de heure"], ["class", "list-tech", 4, "ngFor", "ngForOf"], [1, "col-lg-12"], ["echarts", "", 1, "echart", 3, "options"], [1, "col-lg-8"], ["echarts", "", 1, "demo-chart", 3, "options"], [1, "col-lg-4", 3, "formGroup"], [1, "fix-header-flip"], ["nbInput", "", "placeholder", "Pick Date Range", "fullWidth", "", "formControlName", "filterGain", 3, "nbDatepicker"], ["formpicker", ""], ["icon", "flip-2-outline", 1, "icon", 3, "click"], [1, "subtitle"], [1, "h3"], ["status", "success", 3, "value"], [1, "caption", "description"], ["status", "warning", 3, "value"], ["status", "danger", 3, "value"], [1, "col-lg-6"], [1, "list-tech"], [1, "scrollable-cell"]],
        template: function DashboardComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](40, "Total r\xE9paration");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function DashboardComponent_Template_nb_icon_click_69_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](96, "Les demandes d'intervention annul\xE9s");
          ...
          if (rf & 2) {
            var _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵreference"](68);
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "DashboardsRoutingModule": function DashboardsRoutingModule() {
          return (
            /* binding */
            _DashboardsRoutingModule
          );
        }
        /* harmony export */
      ...
      var _DashboardsRoutingModule = function _DashboardsRoutingModule() {
        _classCallCheck(this, _DashboardsRoutingModule);
      };

      _DashboardsRoutingModule.ɵfac = function DashboardsRoutingModule_Factory(t) {
        return new (t || _DashboardsRoutingModule)();
      };

      _DashboardsRoutingModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
        type: _DashboardsRoutingModule
      });
      _DashboardsRoutingModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__.RouterModule.forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_2__.RouterModule]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](_DashboardsRoutingModule, {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "DashboardsModule": function DashboardsModule() {
          return (
            /* binding */
            _DashboardsModule
          );
      ...
      var _dashboards_routing_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _charts_charts_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _DashboardsModule = function _DashboardsModule() {
        _classCallCheck(this, _DashboardsModule);
      };

      _DashboardsModule.ɵfac = function DashboardsModule_Factory(t) {
        return new (t || _DashboardsModule)();
      };

      _DashboardsModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineNgModule"]({
        type: _DashboardsModule
      });
      _DashboardsModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjector"]({
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _dashboards_routing_module__WEBPACK_IMPORTED_MODULE_1__.DashboardsRoutingModule, _nebular_theme__WEBPACK_IMPORTED_MODULE_5__.NbCardModule, ngx_echarts__WEBPACK_IMPORTED_MODULE_6__.NgxEchartsModule, _charts_charts_module__WEBPACK_IMPORTED_MODULE_2__.ChartsModule, ngx_echarts__WEBPACK_IMPORTED_MODULE_6__.NgxEchartsModule, _nebular_theme__WEBPACK_IMPORTED_MODULE_5__.NbProgressBarModule, _nebular_theme__WEBPACK_IMPORTED_MODULE_5__.NbListModule, _nebular_theme__WEBPACK_IMPORTED_MODULE_5__.NbTooltipModule, _nebular_theme__WEBPACK_IMPORTED_MODULE_5__.NbInputModule, _nebular_theme__WEBPACK_IMPORTED_MODULE_5__.NbDatepickerModule, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.ReactiveFormsModule, _nebular_theme__WEBPACK_IMPORTED_MODULE_5__.NbIconModule]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](_DashboardsModule, {
...
//# sourceMappingURL=src_app_pages_dashboards_dashboards_module_ts-es5.js.map