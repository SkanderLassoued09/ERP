...
@Component({
  selector: "ngx-table-ticket-admin-tech",
  templateUrl: "./table-ticket-admin-tech.component.html",
  styleUrls: ["./table-ticket-admin-tech.component.scss"],
})
export class TableTicketAdminTechComponent implements OnInit {
  ticketForAdminTech: any;
  ...
  ngOnInit(): void {
    this.getTicketFroAdminTech();
  }

  getTicketFroAdminTech() {
    this.apollo
      .query<any>({
        query: this.ticketService.getTicketForAdminTech(),
      })
      .subscribe(({ data }) => {
        this.ticketForAdminTech = data.getTicketForAdminTech;
      });
  }
