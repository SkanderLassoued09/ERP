...
@Component({
  selector: "ngx-table-ticket-admin",
  templateUrl: "./table-ticket-admin.component.html",
  styleUrls: ["./table-ticket-admin.component.scss"],
})
export class TableTicketAdminComponent implements OnInit {
